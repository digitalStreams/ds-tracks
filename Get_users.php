...
<title>list of all user names</title>
<H1>List of all user names <a href="Get_users_Audio.php" ><button class="button button3">List of all user Music By Name</button></a>
...
<thead><tr><th>Users Name</th></tr></thead><tbody>
<?php
    // Configuration
    ...
    foreach ($dirs as $key => $value) {
        ...
        $safeDirName = htmlspecialchars($dirName, ENT_QUOTES, 'UTF-8');
